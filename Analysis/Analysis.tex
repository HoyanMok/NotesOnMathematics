...
\section{\texorpdfstring{Riemann Integral on $n$-D cuboids}{Riemann Integral on n-D cuboids}}
...
\begin{definition}[Mesh]
	The \indexbf{mash} of a partition $P$ is the maximum diametre of the cuboids in $P$:
	\begin{equation*}
...
\begin{theorem}[Lebesgue's criterion]
	...
	$f \in \mathfrak R(I)$ $\IFF$ $f$ is bounded in $I$ and $f$ is almoost everywhere continuous on $I$.
\end{theorem}
\begin{proof}
