...
\end{theorem}
\begin{proof}
	% TODO finish proof of the colosure of a connected set is also a connected set
\end{proof}
...
\begin{definition}[Improper integral]
	...
	If $\exists I \in Y$ s.t.\  $\forall$ exhaustion~$\langle E_n \rangle_{n \in \mathbb N} \in E^\mathbb N$ that $\forall n \in \mathbb N$, $f|_{E_n} \in \mathfrak R(E_n)$, 
	\begin{equation*}
...
\begin{theorem}[Existance of improper integral for non-negative function]
