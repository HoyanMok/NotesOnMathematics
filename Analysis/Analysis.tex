...
\begin{proof}
	...
	In every $S_k$ we can find a $\bv x_{i_k}$, which is a convergent subsequence of the arbitrary sequence~$(\bv x_i)_{i \in \mathbb N}$.
\end{proof}
...
\begin{proof}
	...
	Since $D_x \backslash S_x$ is open, it and its boundary must be disjoint, and the later contains $\partial S_x$. 
	Hence: $(D_x \backslash S_x) \cap \partial S_x = \varnothing$. 
