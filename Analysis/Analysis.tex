...
\begin{theorem}
	...
	% Define a mapping from $[0, 1]$ to $Y$:
	% \begin{equation*}
	% 	g(t) := f(\bv x + t \Delta \bv x) - \sum_{k \in n + 1} \frac{1}{k!} f^{(k)}(\bv x) (t \Delta \bv x)^k\,.
	% \end{equation*}
	...
	\end{equation*}
	% then $g(t)$ is differentiable in $(0, 1)$ and $\forall t \in (0, t)$, 
	% \begin{equation*}
	% 	\|g'(t)\| \leq \frac{1}{n!} M \|t \Delta \bv x\|_X^n \|\Delta \bv x\|_X\,.
	% \end{equation*}
\end{theorem}
\begin{proof}
	\url{https://math.stackexchange.com/questions/3954622/a-version-of-taylors-theorem-in-normed-space-from-zorichs-mathematical-analysi}
\end{proof}
...
\begin{theorem}[Implicit function theorem]
	...
	\begin{conditionlist}[label=\alph*)]
		...
		\begin{equation*}
			\partial_{\bv y} F(\bv x_0, \bv y_0) \circ [\partial_{\bv y} F(\bv x_0, \bv y_0)]^{-1} = [\partial_{\bv y} F(\bv x_0, \bv y_0)]^{-1} \partial_{\bv y} F(\bv x_0, \bv y_0)\,,
		\end{equation*}
	\end{conditionlist}
